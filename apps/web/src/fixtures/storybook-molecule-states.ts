...
export const storybookMoleculeStates = {
  ...
  bulkSelection: {
    ...
    caption: 'Results waiting for review',
    noun: ['result', 'results'],
    pageLabel: 'all reviewable results on this page',
    clearedReason: 'you can see the routing details but not the clinical content',
    reassignLabel: 'Reassign to another clinician',
    dispositionLabel: 'Record review outcome',
    dispositionBlocked:
      'A review outcome is recorded one result at a time, so nothing is closed without being read.',
    selectAllLabel: 'Select all 240 matching results',
    longAction: 'Reassign to the after-hours covering clinician for the Wongaburra catchment',
    rows: [
      {
        id: 'r-9041',
        patient: 'Marlee Tran',
        received: '4 Sep 2026',
        source: 'Northside Demo Pathology',
        kind: 'Full blood count',
        owner: 'Dr Rowena Aspinall',
        state: 'Unreviewed',
        restricted: null,
      },
      {
        id: 'r-9042',
        patient: 'Marley Tranh',
        received: '4 Sep 2026',
        source: 'Northside Demo Pathology',
        kind: 'Iron studies',
        owner: 'Dr Rowena Aspinall',
      ...
      {
        id: 'r-9043',
        patient: 'Joseph Okafor',
        received: '3 Sep 2026',
        source: 'Harbour Street Demo Imaging',
        kind: 'Chest x-ray',
        owner: 'Dr Aroha Duong',
        state: 'Unreviewed',
        restricted: null,
      },
      {
        id: 'r-9044',
        patient: 'Not yet matched',
        received: '3 Sep 2026',
        source: 'Wongaburra Demo Laboratory',
        kind: 'Cervical screening',
        owner: 'Unassigned',
        state: 'Unmatched',
        restricted: 'Sensitive result. Reassignment needs additional access.',
      },
      {
        id: 'r-9045',
        patient: 'Wilhelmina Papadopoulos-Ashworth',
        received: '2 Sep 2026',
        source: 'Wongaburra Community Health and Allied Services Demonstration Laboratory',
        kind: 'Vitamin D and thyroid function panel',
        owner: 'Dr Aroha Duong',
        state: 'Follow-up due',
        restricted: null,
      },
      {
        id: 'r-9046',
        patient: 'Hamish Okonkwo-Delacroix',
        received: '1 Sep 2026',
        source: 'Northside Demo Pathology',
        kind: 'Urine culture',
        owner: 'Dr Rowena Aspinall',
    ...
    entries: [
      {
        ...
        summary: 'Sore throat and fever for three days. Examination unremarkable. Fluids and review if not settling.',
        status: 'recorded',
      },
      {
        key: 't-2',
        ...
        summary: 'Temperature 37.8 °C · Blood pressure 118/74 · Weight 74.6 kg',
        status: 'recorded',
      },
      {
        key: 't-3',
        ...
        summary: 'Reviewed at home after discharge. Dressing changed. District nursing to continue daily.',
        status: 'recorded',
      },
      {
        key: 't-5',
        effectiveAt: '2026-08-22T16:40:00+10:00',
        type: 'Consultation note',
        author: 'Dr Rowena Aspinall',
        summary: 'Dose of the second agent was recorded incorrectly. The correct dose is recorded here.',
        status: 'amendment',
        chain: 'Amends the consultation note of 20 August 2026. The original text is unchanged.',
      },
      {
        key: 't-4',
        effectiveAt: '2026-08-20T11:00:00+10:00',
        type: 'Consultation note',
        author: 'Dr Rowena Aspinall',
        summary: 'Medication review. Continue current therapy.',
        status: 'amended',
        chain: 'Amended on 22 August 2026 by Dr Rowena Aspinall.',
      },
      {
        key: 't-6',
        effectiveAt: '2026-08-14T10:15:00+10:00',
        type: 'Consultation note',
        author: 'Dr Aroha Duong',
        summary: 'Entered against the wrong patient. Retained for audit; not part of this record.',
        status: 'entered-in-error',
        chain: 'Marked entered in error on 14 August 2026 by Dr Aroha Duong.',
      },
    ],
